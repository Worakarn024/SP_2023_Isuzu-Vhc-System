<template>
	<div>
		...
		<div>
			<list-customer-history v-for="item in listCardCar" :key="item.register" :item="item" />
		</div>
...
<script>
import listCustomerHistory from '../../components/list-customerhistory.vue';
import searchBarhistory from '../../components/search-barhistory.vue';
export default {
	components: { searchBarhistory, listCustomerHistory },
	data() {
		return {
			currentPage: 1,
			itemsPerPage: 5,
